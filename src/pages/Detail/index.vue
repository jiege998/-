          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd v-for="saleAttrValue in item.spuSaleAttrValueList" @click ="changeActive(saleAttrValue,item.spuSaleAttrValueList)" changepirce="0" :key="saleAttrValue.id" :class="{active:saleAttrValue.isChecked == 1}">{{saleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$store.dispatch('getDtailInfo',this.$route.params.skuid)
    },
    methods:{
