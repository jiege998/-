  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
        <span class="username" :class="{selected:paymentWay == 'ONLINE'}" @click="paymentWay = 'LINE'?paymenWay='ONLINE':paymenWay='LINE'">在线支付</span>
        <span class="username" :class="{selected:paymentWay == 'LINE'}"  style="margin-left:5px;" @click="paymentWay = 'ONLINE'?paymenWay='LINE':paymenWay='ONLINE'">货到付款</span>
  ...
  export default {
    ...
    methods: {
      ...
      submitOrder(){
        ...
        const obj ={
          consignee:this.addressDefault.consignee,
          consigneeTel:this.addressDefault.phoneNum,
          deliveryAddress:this.addressDefault.fullAddress,
        ...
        this.$API.reqSubmitOrder(tradeNo,obj).then(res=>{
          console.log(res)
          if(res.code == 200){
